...
export const setBusinessDetails = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
...
export const toggleAvailability = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
...
export const submitDocument = async (req: AuthenticatedRequest & { file?: any }, res: Response, next: NextFunction) => {
  try {
    if (!req.file) {
    ...
    const uploadResult = (await uploadImageBuffer(req.file.buffer, "rider_documents")) as { secure_url: string };
...
export const updateBankAccount = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
