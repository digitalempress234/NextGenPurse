...
const pageArgs = (query: any = {}, defaultLimit = 20) => {
...
const ensureAuthenticatedUser = (user: any) => {
  if (!user?.id && !user?._id) {
    throw createHttpError("Authentication required", 401);
  }
};

const getUserId = (user: any) => toIntId(user.id ?? user._id, "user id");

const ensureParticipant = async (participantId: any) => {
...
export const ensureConversationAccess = async (user: any, conversationIdValue: any) => {
...
export const listChatUsers = async (requester: any, query: any = {}) => {
...
export const listAdminChatUsers = async (query: any = {}) => {
...
export const listConversations = async (adminUser: any, query: any = {}) => {
...
export const startConversation = async (adminUser: any, participantIdValue: any) => {
  ensureAuthenticatedUser(adminUser);
...
export const getMessages = async (adminUser: any, conversationIdValue: any, query: any = {}) => {
...
export const sendMessage = async (adminUser: any, conversationIdValue: any, bodyValue: any) => {
  ...
  if (body.length > 5000) throw createHttpError("Message body is too long", 400);
...
export const markConversationRead = async (adminUser: any, conversationIdValue: any) => {
